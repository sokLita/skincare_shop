$filePath = "C:\Users\LITA.SOK\Desktop\skincare_shop\frontend\src\views\Profile.vue"
...
.profile-photo-overlay i { font-size: 28px; }
.profile-photo-overlay span { font-size: 0.72rem; font-weight: 600; }
...
.profile-email { color: #6366f1; font-size: 0.9rem; font-weight: 500; margin-bottom: 2px; }
.profile-phone { color: #6b6575; font-size: 0.85rem; margin-bottom: 0; }
.btn-upload-photo {
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
.btn-upload-photo:hover:not(:disabled)::before { opacity: 1; }
.btn-upload-photo:disabled { opacity: 0.7; cursor: not-allowed; }
.btn-upload-photo .btn-icon, .btn-upload-photo span { position: relative; z-index: 1; }
...
.info-item { display: flex; align-items: center; gap: 12px; justify-content: center; }
.info-icon-box {
  width: 36px;
  height: 36px;
  border-radius: 10px;
...
.info-text { font-size: 0.85rem; color: #6b6575; font-weight: 450; }
...
.input-group-modern:focus-within .input-icon { color: #6366f1; }
.input-icon--textarea { align-items: flex-start; padding-top: 14px; }
.form-control-modern {
  flex: 1;
  border: none;
  padding: 12px 14px;
...
.form-control-modern::placeholder { color: #b8aab8; font-weight: 400; }
.form-control-modern:disabled { background: #f5f0f4; color: #8a7a8a; cursor: not-allowed; }
.form-control-modern--textarea { resize: vertical; min-height: 70px; line-height: 1.5; }
.form-hint { display: flex; align-items: center; gap: 6px; margin-top: 8px; font-size: 0.78rem; color: #a89ab0; }
...
.strength-bar.weak::after { width: 33%; background: linear-gradient(90deg, #f43f5e, #fb7185); }
.strength-bar.medium::after { width: 66%; background: linear-gradient(90deg, #d946ef, #e879f9); }
.strength-bar.strong::after { width: 100%; background: linear-gradient(90deg, #6366f1, #818cf8); }
.strength-text { font-size: 0.78rem; font-weight: 600; white-space: nowrap; }
.strength-bar.weak + .strength-text { color: #f43f5e; }
.strength-bar.medium + .strength-text { color: #d946ef; }
.strength-bar.strong + .strength-text { color: #6366f1; }
.mismatch-hint { display: flex; align-items: center; gap: 6px; margin-top: 8px; font-size: 0.8rem; }
.mismatch-hint--error { color: #f43f5e; }
.mismatch-hint--success { color: #10b981; }
...
.btn-save:hover:not(:disabled) { transform: translateY(-3px); box-shadow: 0 8px 28px rgba(99, 102, 241, 0.4); }
.btn-save:hover:not(:disabled)::before { opacity: 1; }
...
.btn-reset:hover { border-color: #6366f1; color: #6366f1; background: rgba(99, 102, 241, 0.04); transform: translateY(-2px); }
.btn-change-password {
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
.btn-change-password:hover:not(:disabled) { transform: translateY(-3px); box-shadow: 0 8px 28px rgba(217, 70, 239, 0.4); }
.btn-change-password:hover:not(:disabled)::before { opacity: 1; }
.btn-change-password:disabled { opacity: 0.7; cursor: not-allowed; }
.btn-change-password i, .btn-change-password span { position: relative; z-index: 1; }
.alert-glass {
  display: flex;
  align-items: center;
...
.alert-glass--success { background: rgba(16, 185, 129, 0.1); color: #065f46; border-color: rgba(16, 185, 129, 0.2); box-shadow: 0 4px 16px rgba(16, 185, 129, 0.1); }
.alert-glass--error { background: rgba(244, 63, 94, 0.1); color: #9f1239; border-color: rgba(244, 63, 94, 0.2); box-shadow: 0 4px 16px rgba(244, 63, 94, 0.1); }
.alert-content { display: flex; align-items: center; gap: 10px; }
.alert-icon { font-size: 1.05rem; }
.alert-close { background: none; border: none; font-size: 1.4rem; color: inherit; cursor: pointer; opacity: 0.5; padding: 0 4px; line-height: 1; transition: opacity 0.2s; }
.alert-close:hover { opacity: 1; }
.alert-fade-enter-active { animation: alertSlideDown 0.4s ease; }
.alert-fade-leave-active { animation: alertSlideDown 0.35s ease reverse; }
...
@media (max-width: 1024px) {
  ...
  .profile-card--photo { position: static; }
  .profile-title { font-size: 2rem; }
  .profile-page { padding: 90px 0 60px; }
}
@media (max-width: 768px) {
  ...
  .profile-photo-wrapper { width: 130px; height: 130px; }
  .profile-page { padding: 80px 0 40px; }
  .form-actions { flex-direction: column; }
  .btn-reset { width: 100%; }
  .header-badge { width: 60px; height: 60px; font-size: 26px; }
}
@media (max-width: 480px) {
  .profile-title { font-size: 1.5rem; }
  .card-body { padding: 20px 16px; }
  .profile-photo-wrapper { width: 110px; height: 110px; }
  .profile-initial { font-size: 2.6rem; }
}
</style>
