        ...
        <div class="col-lg-5 col-md-7 col-11">
          <div class="auth-card">
            <div class="auth-card-inner">
              ...
              <form v-if="!successMsg" @submit.prevent="handleForgotPassword" class="auth-form">
                ...
                <button type="submit" class="auth-btn" :disabled="loading">
                  ...
                  <span v-else>Send Reset Link <i class="fas fa-paper-plane ms-2"></i></span>
                </button>
              </form>
  ...
  methods: {
    async handleForgotPassword() {
      ...
      try {
        ...
        this.successMsg = 'If an account with that email exists, we have sent a password reset link.'
        this.form.email = ''
      } catch (error) {
