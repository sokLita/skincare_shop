          ...
          <div class="auth-card">
            <div class="auth-card-inner">
              ...
              <form @submit.prevent="handleLogin" class="auth-form">
                <div class="form-group">
                  ...
                  <div class="input-group-custom">
                    ...
                    <input type="email" id="email" v-model="form.email" class="form-input" placeholder="you@example.com" required />
                ...
                <div class="form-group">
                  ...
                  <div class="input-group-custom">
                    ...
                    <input :type="showPassword ? 'text' : 'password'" id="password" v-model="form.password" class="form-input" placeholder="Enter your password" required />
              ...
              <div class="social-btns">
                <button type="button" class="social-btn social-btn--google" @click="socialLogin('google')">
                  <i class="fab fa-google"></i>
                  <span>Google</span>
                </button>
                <button type="button" class="social-btn social-btn--facebook" @click="socialLogin('facebook')">
              ...
              <div class="demo-creds">
                ...
                <strong>Demo:</strong> user@skincare.com / user123
              </div>
            </div>
          </div>
        </div>
  ...
  methods: {
    async handleLogin() {
      ...
      if (result.success) {
        ...
        this.errorMsg = result.error || 'Invalid email or password. Please try again.'
      }
    },
    socialLogin(provider) {
      this.errorMsg = provider + ' login coming soon!'
    }
  }
}
</script>
...
.checkbox-wrap { display:flex; align-items:center; gap:10px; cursor:pointer; user-select:none; position:relative; padding-left:28px; }
...
.forgot-link { font-size:13px; color:#667eea; text-decoration:none; font-weight:500; transition:all 0.3s ease; }
